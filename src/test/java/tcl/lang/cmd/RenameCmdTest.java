...
public class RenameCmdTest extends TclCmdTest {
  ...
  public void testCmd() throws Exception {
    // FIXME: rename.test altered to run test "rename-6.1 {old code invalidated (epoch incremented)
    // when cmd with compile proc is renamed } {"
    ...
    //		test rename-6.1 {old code invalidated (epoch incremented) when cmd with compile proc is
    // renamed } {
    //		    proc x {} {
    //		        set a 123
    //		        set b [incr a]
