...
/**
 * Represents a redirection on one of the streams attached to a TclProcess. Inspired by the Java 1.7
 * API.
 */
public class Redirect {
   ...
   *
   * @param partner TclProcess on the other side of the pipe. This Redirect object is attached to
   *     the TclProcess on this side of the pipe.
   */
   ...
   *
   * @param f File to redirect bytes from/to
   * @param specifiedPath File name as specified to Tcl; used for error messages
   */
   ...
   *
   * @param channel to redirect bytes from/to
   * @param close if true, close channel on process exit
   */
  ...
  /**
   * @param inputStream the inputStream to set for STREAM redirects. Must be set by TclProcess
   *     subclass.
   */
  ...
  /**
   * @param outputStream the outputStream to set for STREAM redirects. Must be set by TclProcess
   *     subclass.
   */
