...
public class TraceRecord {
  ...
  /**
   * Stores info about the conditions under which this trace should be triggered. Should be a
   * combination of TCL.TRACE_READS, TCL.TRACE_WRITES or TCL.TRACE_UNSETS.
   */
  int flags;
