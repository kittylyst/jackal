...
public class CommandTrace {
   ...
   *
   * @param type either DELETE or RENAME
   * @param callbackCmd command to execute when fired
   */
  ...
  /**
   * Call the callback function for this CommandTrace if it matches type. Any errors in the callback
   * function are ignored.
   *
   * @param type type of trace being executed (DELETE or RENAME)
   * @param oldname old name of command being renamed or deleted
   * @param newname new name of command being renamed; ignored for DELETE type
   */
