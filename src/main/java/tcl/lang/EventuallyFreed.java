...
abstract class EventuallyFreed {
   ...
   * ----------------------------------------------------------------------
   *
   * <p>Tcl_Preserve -> preserve
   *
   * <p>This method is used by another method to declare its interest in this particular object, so
   * that the object will not be disposed until a matching call to release() has been made.
   *
   * <p>Results: None.
   *
   * <p>Side effects: Information is retained so that the object will not be disposed until at least
   * the matching call to release().
   *
   * <p>----------------------------------------------------------------------
   */
  public void preserve() {
    ...
    if (debug) {
      System.out.println("Incremented refCount to " + refCount + " for " + this);
    }
  }
  ...
  public void release() {
    ...
    if (debug) {
      System.out.println("Decremented refCount to " + refCount + " for " + this);
    }
