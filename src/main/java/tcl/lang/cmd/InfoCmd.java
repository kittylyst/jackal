...
public final class InfoCmd implements Command {
   ...
   *
   * <p>This procedure is invoked to process the "info" Tcl command. See the user documentation for
  ...
  /**
   * Called to implement the "info args" command that returns the argument list for a procedure.
   * Handles the following syntax:
   *
   * <p>info args procName
   *
   * @param interp
   * @param objv
   * @throws TclException
  ...
  /**
   * Called to implement the "info body" command that returns the body for a procedure. Handles the
   * following syntax:
   *
   * <p>info body procName
   *
   * @param interp
   * @param objv
   * @throws TclException
  ...
  /**
   * Called to implement the "info cmdcount" command that returns the number of commands that have
   * been executed. Handles the following syntax:
   *
   * <p>info cmdcount
   *
   * @param interp
  ...
  /**
   * Called to implement the "info commands" command that returns the list of commands in the
   * interpreter that match an optional pattern. The pattern, if any, consists of an optional
   * sequence of namespace names separated by "::" qualifiers, which is followed by a glob-style
   * pattern that restricts which commands are returned. Handles the following syntax:
   *
   * <p>info commands ?pattern?
   *
   * @param interp
   * @param objv
   * @throws TclException
  ...
  /**
   * Called to implement the "info complete" command that determines whether a string is a complete
   * Tcl command. Handles the following syntax:
   *
   * <p>info complete command
   *
   * @param interp
   * @param objv
   * @throws TclException
  ...
  /**
   * Called to implement the "info default" command that returns the default value for a procedure
   * argument. Handles the following syntax:
   *
   * <p>info default procName arg varName
   *
   * @param interp
   * @param objv
   * @throws TclException
      ...
      if (argName.equals(proc.argList[i][0].toString())) {
        ...
        try {
          ...
          throw new TclException(
              interp, "couldn't store default value in variable \"" + varName + "\"");
        }
        return;
      }
    }
    throw new TclException(
        interp, "procedure \"" + procName + "\" doesn't have an argument \"" + argName + "\"");
  }

  /**
   * Called to implement the "info exists" command that determines whether a variable exists.
   * Handles the following syntax:
   *
   * <p>info exists varName
   *
   * @param interp
   * @param objv
   * @throws TclException
  ...
  /**
   * Called to implement the "info functions" command that returns the list of math functions
   * currently defined matching an optional pattern. Handles the following syntax:
   *
   * <p>info functions ?pattern?*
   *
   * @param interp
   * @param objv
   * @throws TclException
  ...
  /**
   * Called to implement the "info globals" command that returns the list of global variables
   * matching an optional pattern. Handles the following syntax:
   *
   * <p>info globals ?pattern?*
   *
   * @param interp
   * @param objv
   * @throws TclException
  ...
  /**
   * Called to implement the "info hostname" command that returns the host name. Handles the
   * following syntax:
   *
   * <p>info hostname
   *
  ...
  /**
   * Called to implement the "info level" command that returns information about the call stack.
   * Handles the following syntax:
   *
   * <p>info level ?number?
   *
  ...
  /**
   * Called to implement the "info library" command that returns the library directory for the Tcl
   * installation. Handles the following syntax:
   *
   * <p>info library
   *
   * @param interp
  ...
  /**
   * Called to implement the "info loaded" command that returns the packages that have been loaded
   * into an interpreter. Handles the following syntax:
   *
   * <p>info loaded ?interp?
   *
   * @param interp
   * @param objv
   * @throws TclException
   ...
   * file running this application. This implementation attempts to locate the Java VM executable,
   * creates a new temporary file as a shell/bat script to invoke the JVM executable with the
   * current classpath and shell, and returns the temporary file name.
   *
    ...
    if (createExecFile) {
      ...
      if (javaHome != null) {
        ...
        if (javaPath.exists()) {
          ...
          // IBM's JDK on AIX uses strange locations for the executables (from Apache Maven
          // 'bin/mvn')
      ...
      if (!isWindows) {
        try {
          ...
          throw new TclException(
              interp, "Couldn't set executable file as executable [name of executable]");
        }
      }
  ...
  /**
   * Called to implement the "info patchlevel" command that returns the default value for an
   * argument to a procedure. Handles the following syntax:
   *
   * <p>info patchlevel
   *
   * @param interp
  ...
  /**
   * Called to implement the "info procs" command that returns the procedures in the current
   * namespace that match an optional pattern. Handles the following syntax:
   *
   * <p>info procs ?pattern?
   *
   * @param interp
   * @param objv
   * @throws TclException
  ...
  /**
   * Called to implement the "info script" command that returns the script file that is currently
   * being evaluated. Handles the following syntax:
   *
   * <p>info script ?filename?
   *
   * @param interp
   * @param objv
   * @throws TclException
  ...
  /**
   * Called to implement the "info sharedlibextension" command that returns the file extension used
   * for shared libraries. Handles the following syntax:
   *
   * <p>info sharedlibextension
   *
   * @param interp
   * @param objv
   * @throws TclException
  ...
  /**
   * Called to implement the "info tclversion" command that returns the version number for this Tcl
   * library. Handles the following syntax:
   *
   * <p>info tclversion
   *
   * @param interp
  ...
  /**
   * Called to implement the "info vars" command that returns the list of variables in the
   * interpreter that match an optional pattern. The pattern, if any, consists of an optional
   * sequence of namespace names separated by "::" qualifiers, which is followed by a glob-style
   * pattern that restricts which variables are returned. Handles the following syntax:
   *
   * <p>info vars ?pattern?
   *
   * @param interp
