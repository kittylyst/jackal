...
public final class ProcCmd implements Command {
  ...
  public static FindCommandNamespaceResult FindCommandNamespace(Interp interp, String fullName)
      throws TclException {
    String procName;
    ...
    if (ns == null) {
      throw new TclException(
          interp, "can't create procedure \"" + fullName + "\": unknown namespace");
    }
    if (procName == null) {
      throw new TclException(
          interp, "can't create procedure \"" + fullName + "\": bad procedure name");
    }
