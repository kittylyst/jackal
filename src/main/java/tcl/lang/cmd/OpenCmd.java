...
public class OpenCmd implements Command {
  ...
  public void cmdProc(Interp interp, TclObject argv[]) throws TclException {
    ...
    if (!pipeline) {
      ...
      if ((modeFlags & TclIO.WRONLY) == TclIO.WRONLY) modeFlags = TclIO.WRONLY;
      if ((modeFlags & TclIO.RDONLY) == TclIO.RDONLY) modeFlags = TclIO.RDONLY;
      if ((modeFlags & TclIO.RDWR) == TclIO.RDWR) modeFlags = TclIO.RDWR;
