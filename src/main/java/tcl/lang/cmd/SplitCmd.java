...
public class SplitCmd implements Command {
  ...
  /**
   * This procedure is invoked to process the "split" Tcl command. See Tcl user documentation for
   * details.
   *
  ...
  static void appendElement(Interp interp, TclObject list, String string, int starti, int endi)
      throws TclException {
    TclObject tobj;
