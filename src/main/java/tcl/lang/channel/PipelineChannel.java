...
public class PipelineChannel extends Channel {
   ...
   *
   * @param interp
   * @param execString String in the form of "exec" or "open"; first '|' is optional
   * @param modeFlags TclIO.RDONLY or TclIO.WRONLY or TclIO.RDWR
   * @return channel name
   * @throws IOException
   * @throws TclException
   */
  public String open(Interp interp, String execString, int modeFlags)
    ...
    if (modeFlags == TclIO.RDONLY) {
      ...
      if (pipeline.getStdoutRedirect() == null) {
        ...
        throw new TclException(
            interp, "can't read output from command: standard output was redirected");
      }
      ...
      if (pipeline.getStdinRedirect() == null) {
        ...
        throw new TclException(
            interp, "can't write input to command: standard input was redirected");
      }
      if (pipeline.getStdoutRedirect() == null) {
