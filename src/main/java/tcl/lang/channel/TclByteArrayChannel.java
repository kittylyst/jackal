...
public class TclByteArrayChannel extends Channel {
   ...
   * @param object TclObject to read from.
   */
  ...
  /**
   * @return a TclObject containing byte array written to this channel. The byte array is not
   *     decoded.
   */
  public TclObject getTclByteArray() {
    if (ostream == null) return TclString.newInstance("");
    TclObject rv = TclByteArray.newInstance(ostream.toByteArray());
    return rv;
  }

  /**
   * @return a TclObject containing the data written to this channel, decoded using the current
   *     system encoding
   */
  ...
  protected InputStream getInputStream() throws IOException {
    if (istream == null) throw new RuntimeException("should not be called");
    else return istream;
  }

  @Override
  protected OutputStream getOutputStream() throws IOException {
    if (ostream == null) throw new RuntimeException("should not be called");
    else return ostream;
  }
}
