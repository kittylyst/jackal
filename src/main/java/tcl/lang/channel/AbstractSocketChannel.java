...
public abstract sealed class AbstractSocketChannel extends Channel
   ...
   * to which the peer socket is connected or bound. If the host name cannot be computed, the second
   * element of the list is identical to the address, its first element
   *
  ...
  /**
   * This option gets the current error status of the given socket. This is useful when you need to
