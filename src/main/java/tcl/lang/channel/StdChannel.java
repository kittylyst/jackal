...
public final class StdChannel extends Channel {
  ...
  /**
   * Reassign the standard input stream to a new stream. This will change the underlying stream for
   * all interpreters. This use is deprecated; applications should unregister the stdin Channel and
   * open a new Channel to replace stdin.
   *
   * @param in InputStream to replace standard input with
   */
  @Deprecated
  ...
  /**
   * Reassign the standard output stream to a new stream. This will change the underlying stream for
   * all interpreters. This use is deprecated; applications should unregister the stdout Channel and
   * open a new Channel to replace it.
   *
   * @param out OutputStream to replace standard input with
   */
  @Deprecated
  ...
  /**
   * Reassign the standard error stream to a new stream. This will change the underlying stream for
   * all interpreters. This use is deprecated; applications should unregister the stderr Channel and
   * open a new Channel to replace it.
   *
   * @param err OutputStream to replace standard input with
   */
  @Deprecated
  ...
  /**
   * Constructor that does nothing. Open() must be called before any of the subsequent read, write,
   * etc calls can be made.
   */
  StdChannel() {}
  ...
  protected InputStream getInputStream() throws IOException {
    if (stdType == STDIN) return _in;
    else throw new RuntimeException("Should never be called");
  }
