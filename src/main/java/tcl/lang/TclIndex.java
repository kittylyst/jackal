...
public class TclIndex implements InternalRep {
   ...
   *
   * <p>Gets the index into the table of the object. Generate an error it it doesn't occur. This
   * also converts the object to an index which should catch the lookup for speed improvement.
   *
