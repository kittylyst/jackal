...
public class TclNumArgsException extends TclException {
  ...
  /**
   * Creates a TclException with the appropiate Tcl error message for having the wring number of
   * arguments to a Tcl command.
   *
   * <p>Example:
   *
   * <pre>
   ...
   * @param argc the number of arguments to copy from the offending command to put into the error
   *     message.
   * @param argv the arguments of the offending command.
   * @param message extra message to appear in the error message that explains the proper usage of
   *     the command.
