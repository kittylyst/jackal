...
public class TclBoolean implements InternalRep {
  ...
  /**
   * Construct a TclBoolean representation with the given boolean value. Note that only two
   * TclBoolean internal rep instances will ever exist.
   *
   ...
   *
   * <p>Called to convert the other object's internal rep to boolean.
   *
   ...
   *
   * <p>An object with a TclBoolean internal rep has a boolean value. An object with a TclInteger
   * internal rep and has the int value "0" or "1" is also a valid boolean value.
   *
   * @param interp current interpreter.
   * @param tobj the TclObject to use as an boolean.
   * @return the boolean value of the object.
   * @exception TclException if the object cannot be converted into a boolean.
   */
  public static boolean get(final Interp interp, final TclObject tobj) throws TclException {
    if (tobj.isIntType()) {
