...
public interface VarTrace {
   ...
   * <p>Results: None.
   *
   * <p>Side effects: The traceProc can cause arbitrary side effects. If a TclException is thrown,
   * error message is stored in the result of the interpreter.
   *
   * @param interp current interpreter
   * @param part1 first part of variable name
   * @param part2 array index, or if null, part1 is a scalar or whole array
   * @param flags TCL.TRACE_READS, TCL.TRACE_WRITES or TCL.TRACE_UNSETS (exactly one of these bits
   *     will be set.)
   * @throws TclException
   */
