...
public class ExecutionTrace {
   ...
   *
   * @param type either ENTER, LEAVE, ENTERSTEP, or LEAVESTEP
  ...
  /**
   * @return the type of this trace, either ENTER, LEAVE, ENTERSTEP, or LEAVESTEP
   */
  public int getType() {
    return type;
  }
   ...
   *
   * @param interp
   * @param type type of trace being executedeither ENTER, LEAVE, ENTERSTEP, or LEAVESTEP
   * @param commandString
   * @param resultCode
   * @param result
   */
