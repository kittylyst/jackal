 ...
 * attribute from the manifest. See paraffin.tcl to build a conforming JAR file.
 */
public class AppShell {
   ...
   * <p>Results: None.
   *
   * <p>Side effects: This procedure initializes the Tcl world and then starts interpreting
   * commands; almost anything could happen, depending on the script being interpreted.
   */
