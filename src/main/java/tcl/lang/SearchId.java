...
public class SearchId {
  ...
  /**
   * A SearchId is only created from an ArrayVar object. The ArrayVar constructs a new SearchId
   * object by passing it's current keys stored as an enumeration, a unique string that ArrayVar
   * creates, and an index value used for future SearchId objects.
   *
   * @param iter initial Enumeration
