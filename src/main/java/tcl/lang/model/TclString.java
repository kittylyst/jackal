...
public final class TclString implements InternalRep {
  ...
  /**
   * Create a new TclObject that makes use of the given StringBuffer object. The passed in
   * StringBuffer should not be modified after it is passed to this method.
   */
  ...
  /**
   * Create a TclObject with an internal TclString representation whose initial value is a string
  ...
  /**
   * Appends a string to a TclObject object. This method is equivalent to Tcl_AppendToObj() in Tcl
   * 8.0.
   *
  ...
  /**
   * Appends a TclObject to a TclObject. This method is equivalent to Tcl_AppendToObj() in Tcl 8.0.
   *
  ...
  /**
   * Appends the String values of multiple TclObject's to a TclObject. This is an optimized
   * implementation that will measure the length of each string and expand the capacity as needed to
   * limit reallocations.
   *
   ...
   * This method is used only in the IO layer.
   */
