...
public final class TclParser implements Command {
  ...
  static void ParseCommand(
    ...
    parse = Parser.parseCommand(interp, script.array, charIndex, charLength, null, -1, false);
    ...
    if (parse.commentStart != -1) {
      ...
      TclList.append(interp, resultPtr, ParseMakeRange(script, script.index, 0));
    }
    TclList.append(
  ...
  static void ParseVarName(
    ...
    parse = Parser.parseVarName(interp, script.array, charIndex, charLength, null, false);
    if (parse.result != TCL.OK) {
      ParseSetErrorCode(interp, script, parse);
    }
