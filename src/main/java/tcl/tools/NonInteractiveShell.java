 ...
 * prompt or the command results to standard out. It's main purpose is for testing JTCL.
 *
 * <p>The TCL test suite execs a shell with redirected stdin to test several command, and inspects
 * the results from stdout (which shouldn't include the '%' prompt). C TCL automatically creates a
