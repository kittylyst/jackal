...
public class Ensemble {
  ...
  static void CreateEnsembleFailed(Interp interp, String ensName, TclException ex)
      throws TclException {
  ...
  static void AddEnsemblePartFailed(Interp interp, String ensName, TclException ex)
      throws TclException {
  ...
  static boolean GetEnsembleUsage(
      Interp interp, // interpreter containing the
      // ensemble
  ...
  static boolean GetEnsembleUsageForObj(
  ...
  static void GetEnsemblePartUsage(
      EnsemblePart ensPart, // ensemble part for
      // usage info
  ...
  static EnsemblePart AddEnsemblePart(
      Interp interp, // interpreter to be
      // updated
  ...
  static EnsemblePart CreateEnsemblePart(
      Interp interp, // interpreter
      // containing the
      // ensemble
  ...
  static EnsemblePart FindEnsemblePart(
      Interp interp, // interpreter
      // containing the
      // ensemble
  ...
  static FindEnsemblePartIndexResult FindEnsemblePartIndex(
      ...
      // then get its data.
        ...
        if (cmd == null || !(cmd instanceof HandleEnsemble)) {
          throw new TclException(
              interp, "command \"" + objv[1].toString() + "\" is not an ensemble");
        }
        ensData = ((HandleEnsemble) cmd).ensData;
      }
  ...
  static void DeleteEnsParser(
      EnsembleParser ensInfo, // parser for
      // ensemble-related
      // commands
  ...
  public static final class EnsPartCmd implements Command {
    ...
    public void cmdProc(
      ...
      if (objv.length != 4) {
        throw new TclException(
            interp, "wrong # args: should be \"" + objv[0].toString() + " name args body\"");
      }
  ...
  static void EnsembleErrorCmd(
      Ensemble ensData, // like client data in C
      // version
      Interp interp,
      TclObject[] objv,
      int skip)
  ...
  static void SetEnsInvocFromAny(
      Interp interp, // Determines the context for
      // name resolution
