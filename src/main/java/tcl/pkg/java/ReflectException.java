...
/**
 * This class handles Exception's caught while invoking the Reflection API. It records the string
 * form of the Exception into the result of the interpreter and stores the actual Exception object
 * in the errorCode of the interpreter.
 */
  ...
  ReflectException(
    ...
    if (interp != null) {
      ...
      try {
        ...
        TclList.append(
            interp, errCode, ReflectObject.newInstance(interp, Throwable.class, throwable));
