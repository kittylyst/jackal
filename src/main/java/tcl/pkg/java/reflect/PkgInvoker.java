...
public class PkgInvoker {
  ...
  public static boolean isAccessible(Class cls) {
    ...
    if (usesDefaultInvoker(cls)) return false;
    return true;
  }
  ...
  public static boolean isAccessible(Method meth) {
    ...
    if (Modifier.isPublic(mod)) return true;
    if (Modifier.isPrivate(mod)) return false;
    if (usesDefaultInvoker(meth.getDeclaringClass())) return false;
    return true;
  }
  ...
  public static boolean isAccessible(Constructor cons) {
    ...
    if (Modifier.isPublic(mod)) return true;
    if (Modifier.isPrivate(mod)) return false;
    if (usesDefaultInvoker(cons.getDeclaringClass())) return false;
    return true;
  }
  ...
  public static boolean isAccessible(Field fld) {
    ...
    if (Modifier.isPublic(mod)) return true;
    if (Modifier.isPrivate(mod)) return false;
    if (usesDefaultInvoker(fld.getDeclaringClass())) return false;
    return true;
  }
} // end PkgInvoker
