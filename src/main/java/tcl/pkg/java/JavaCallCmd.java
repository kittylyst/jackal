...
public final class JavaCallCmd implements Command {
  ...
  public void cmdProc(
    ...
    if (argv.length < 3) {
      throw new TclNumArgsException(interp, 1, argv, "?-noconvert? class signature ?arg arg ...?");
    }
    ...
    TclObject result =
        JavaInvoke.callStaticMethod(
            interp, argv[classIdx], argv[classIdx + 1], argv, startIdx, count, convert);
