...
/**
 * This class implements the built-in "java::for" command. This command is semantically equivalent
  ...
  public void cmdProc(Interp interp, TclObject[] objv) throws TclException {
    ...
    if (isArrayVarname(varname) || varname.indexOf("::") != -1) {
      throw new TclException(
          interp, "invalid type_var \"" + type_var + "\", varname must be simple scalar");
    }
        ...
        case ARRAY_OBJECT:
          {
            ...
            if (type.isPrimitive()
                && (((type == Integer.TYPE) && (elem_class == Integer.class))
                    ...
                    || ((type == Short.TYPE) && (elem_class == Short.class))
                    || ((type == Character.TYPE) && (elem_class == Character.class)))) {
              // No-op
