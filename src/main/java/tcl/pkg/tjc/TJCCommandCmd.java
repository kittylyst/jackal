...
public final class TJCCommandCmd implements Command {
  ...
  public void cmdProc(Interp interp, TclObject[] objv) throws TclException {
    ...
    try {
      ...
      throw new TclException(interp, "instance of class " + classname + " could not be created");
    } catch (IllegalAccessException iae) {
      throw new TclException(interp, "instance of class " + classname + " could not be created");
    }
    if (!(o instanceof TJC.CompiledCommand)) {
      throw new TclException(interp, "class " + classname + " must extend TJC.CompiledCommand");
    }
