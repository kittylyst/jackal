...
public final class TJCPackageCmd implements Command {
  ...
  public void cmdProc(Interp interp, TclObject[] objv) throws TclException {
    ...
    String classname = (pkgname.equals("default") ? "TJCExtension" : pkgname + ".TJCExtension");
    ...
    try {
      ...
      throw new TclException(interp, "class " + classname + " could not be created");
    } catch (IllegalAccessException iae) {
      throw new TclException(interp, "class " + classname + " could not be created");
    }
    if (!(o instanceof Extension)) {
      throw new TclException(interp, "class " + classname + " must extend Extension");
    }
