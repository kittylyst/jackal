...
public class TJC {
  ...
  public static void checkTclException(Interp interp, TclException e, String procName)
      throws TclException {
  ...
  public abstract static non-sealed class CompiledCommand implements Command {
    ...
    protected void builtinCommandsCheck(Interp interp) throws TclException {
      ...
      String[] containers = {
        "break", "catch", "continue", "expr", "for", "foreach", "if", "return", "switch", "while"
      };
      ...
      String[] builtin = (inlineCmds ? containers_and_inlines : containers);
      WrappedCommand cmd;
      String cmdName;
    ...
    protected final void initVarScoped(
        final Interp interp,
    ...
    protected final TclObject getVarScalar(
        final Interp interp,
    ...
    protected final TclObject getVarArray(
        final Interp interp,
      ...
      if (var == null || ((var = Var.resolveArray(var)) == null)) {
        return Var.getVarCompiledLocalArrayInvalid(interp, varname, key);
      } else {
        return Var.getVarCompiledLocalArray(interp, varname, key, var, true);
      }
    }
    ...
    protected final TclObject setVarScalar(
        final Interp interp,
        final String varname, // Scalar variable name
      ...
      if (var == null) {
        return Var.initVarCompiledLocalScalar(interp, varname, value, compiledLocals, localIndex);
      } else if ((var = Var.resolveScalar(var)) == null) {
        return Var.setVarCompiledLocalScalarInvalid(interp, varname, value);
      } else {
    ...
    protected final TclObject setVarArray(
        final Interp interp,
        final String varname,
        final String key,
      ...
      if (var == null) {
        ...
        return Var.setVarCompiledLocalArrayInvalid(interp, varname, key, value);
      } else {
        return Var.setVarCompiledLocalArray(interp, varname, key, value, var);
      }
    }
    ...
    protected final TclObject incrVarScalar(
        final Interp interp,
        final String varname,
        final long incrAmount,
        final Var[] compiledLocals,
        final int localIndex)
        throws TclException {
      Var var = compiledLocals[localIndex];
    ...
    protected final TclObject incrVarArray(
        final Interp interp,
        final String varname,
        final String key,
        final long incrAmount,
      ...
      if (var == null || ((var = Var.resolveArray(var)) == null)) {
        ...
        TclObject varValue = Var.getVarCompiledLocalArray(interp, varname, key, var, true);
        ...
        return Var.setVarCompiledLocalArray(interp, varname, key, varValue, var);
      }
    }
    ...
    protected final TclObject lappendVarScalar(
        final Interp interp,
        final String varname,
    ...
    protected final TclObject lappendVarArray(
        final Interp interp,
        final String varname,
        final String key,
        final TclObject[] values,
      ...
      TclObject varValue = Var.getVarCompiledLocalArray(interp, varname, key, var, false);
    ...
    protected final TclObject appendVarScalar(
        final Interp interp,
        final String varname,
        final TclObject[] values,
        final Var[] compiledLocals,
    ...
    protected final TclObject appendVarArray(
        final Interp interp,
        final String varname,
        final String key,
        final TclObject[] values,
  ...
  public static void createCommand(
      Interp interp, // Interp to create command
      // in
  ...
  public static void sourceInitFile(Interp interp, String init_file, String[] files, String prefix)
      throws TclException {
    // Install temp source command
    interp.eval("package require TJC");
    interp.eval("rename ::source ::TJC::source");
    interp.createCommand("::source", new InitSourceCmd(init_file, files, prefix));
  ...
  /**
   * This method is invoked when a compiled incr command is inlined. This methods works for both
   * scalar variables and array scalars. This method is not used for cached variables.
   *
   ...
   * @throws TclException
   */
  public static final TclObject incrVar(Interp interp, String part1, String part2, long incrAmount)
      throws TclException {
  ...
  public static void releaseObjvElems(final Interp interp, final TclObject[] objv, final int size) {
  ...
  public static void invoke(
    ...
    try {
      ...
      if (ex.getCompletionCode() == TCL.ERROR && !(interp.errAlreadyLogged)) {
        ...
        Parser.logCommandInfo(
            interp, script_array, script_index, command_start, command_length, ex);
      }
  ...
  public static boolean getBoolean(final Interp interp, final TclObject obj) throws TclException {
    if (obj.isIntType()) {
  ...
  public static int invokeSwitch(
      ...
      throws TclException {
    int offset = SwitchCmd.getBodyOffset(interp, pbObjv, pbStart, string, mode);
    return offset;
  }
  ...
  public static void switchStringIsNotOption(Interp interp, String str) throws TclException {
    if (str.startsWith("-")) {
      ...
      throw new TclNumArgsException(
          interp, 1, objv, "?switches? string pattern body ... ?default body?");
    }
  }
  ...
  public static void exprInitValue(final Interp interp, final ExprValue value, final TclObject tobj)
      throws TclException {
    Expression.ExprParseObject(interp, tobj, value);
  }
  ...
  public static void exprUnaryOperator(
      final Interp interp, // current interp,
      // can't be
      // null.
  ...
  public static void exprBinaryOperator(
      final Interp interp, // current
      // interp, can't
      // be null.
      final int op, // One of the EXPR_OP_* values
      final ExprValue value,
  ...
  public static void exprMathFunction(
      Interp interp, // current interp, can't
      // be null.
  ...
  public static void exprEqualsEmptyString(
      ExprValue value, // Location for
      // result value
  ...
  public static void exprUnaryNotOperator(
      final Interp interp, // current
      // interp,
      // can't be
      // null.
  ...
  public static void exprUnaryNotOperatorKnownInt(
      final ExprValue value, // where
      // to
      // store
      // result
      // of
  ...
  public static final void makeGlobalLinkVar(
      Interp interp,
      String varName, // Fully
      // qualified
      // name
      // of
      // global
    ...
    Var.makeUpvar(interp, null, varName, null, TCL.GLOBAL_ONLY, varTail, 0, localIndex);
  }
  ...
  public static final void lindexNonconst(
      final Interp interp,
    ...
    if (indexValue.isIntType()) {
      TclObject result = TclList.index(interp, listObj, (int) indexValue.ivalue);
      if (result == null) {
        interp.resetResult();
      } else {
  ...
  public static final TclObject lappendVar(
      Interp interp,
      String varName, // Name
      // of
      // variable
  ...
  public static final TclObject appendVar(
      Interp interp,
      String varName, // Name
      // of
      // variable
  ...
  public static final TclObject stringIndex(
      final Interp interp,
  ...
  public static final TclObject stringRange(
      final Interp interp,
      final String str, // string
  ...
  public static final TclObject stringFirst(
      Interp interp,
  ...
  public static final TclObject stringLast(
      Interp interp,
      String substr, // substring
      // to
      // search
